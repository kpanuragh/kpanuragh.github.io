...
1. 92% of maintainers make $0 (this can change!)
2. GitHub Sponsors = zero fees, built-in, easy
3. Set up takes 15 minutes, pays forever
4. Companies WILL sponsor if you ask right
5. Transparency and value proposition matter
6. Start small, build gradually
7. Your time is valuable - get compensated!
...
3. Add bank/Stripe info
4. Create 4-5 tiers ($1, $5, $25, $100, custom)
5. Write a compelling profile
6. Hit "Publish"

**This week:**

1. Add sponsor button to README
2. Tweet about enabling sponsors
3. Write a blog post about your journey
4. Thank any early sponsors!

**This month:**

1. Reach out to 5 companies using your project
2. Create monthly sponsor update
3. Add sponsors to CONTRIBUTORS.md
4. Celebrate your first $50/month! 🎉

**This year:**

1. Build to $500-1,000/month
2. Make OSS sustainable
3. Work more on projects you love
4. Maybe inspire others to fund OSS!
...
- [Setting Up Sponsors](https://docs.github.com/en/sponsors/receiving-sponsorships-through-github-sponsors)

**Inspiration:**
- [Thanks.dev](https://thanks.dev/) - See who's getting sponsored
...
**Tools:**
- [Sponsor Kit](https://github.com/JessicaSachs/sponsor-kit) - Auto-generate sponsor README sections
- [Shields.io](https://shields.io/) - Sponsor badges for README
...
**Ready to get sponsored?** Enable GitHub Sponsors RIGHT NOW and share your profile! Connect with me on [LinkedIn](https://www.linkedin.com/in/anuraghkp) - I want to see your sponsor page!

**Want to sponsor someone?** Check out my [GitHub](https://github.com/kpanuragh) and consider sponsoring the projects you use! (Yes, I'm practicing what I preach! 😉)
